# Heti NEJM elemzes a JSON adatokbol
$json = Get-Content .\osszes.json | ConvertFrom-Json
$osszesCikk = $json

# A mai datum es a 7 nappal ezelotti datum
$most = Get-Date
$hetEzelott = $most.AddDays(-7)

# Szures az elmult 7 nap cikkeire a 'date' mezo alapjan
...
# Szakteruletek (specialties) – tobb is lehet vesszovel elvalasztva
