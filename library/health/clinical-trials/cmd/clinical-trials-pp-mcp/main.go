...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/health/clinical-trials/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "clinical-trials-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
