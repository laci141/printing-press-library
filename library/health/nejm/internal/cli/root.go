...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/health/nejm/internal/config"
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "nejm-pp-cli",
		Short: `Nejm CLI — Browse, search, and triage New England Journal of Medicine articles from the terminal, backed by a local corpus and a b…`,
		Long: `Nejm CLI — Browse, search, and triage New England Journal of Medicine articles from the terminal, backed by a local corpus and a b…
...
Health check: run 'nejm-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("nejm-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'nejm-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelOpenAccessCmd(flags))
	...
	// Phase 3 hand-coded commands
	rootCmd.AddCommand(newCurrentCmd(flags))
