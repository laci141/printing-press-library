...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/developer-tools/thelancet/internal/client"
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "thelancet-pp-cli",
		Short: `Thelancet CLI — Search Lancet articles offline and analyze author impact, institutional networks, and editorial trends — powered by the…`,
		Long: `Thelancet CLI — Search Lancet articles offline and analyze author impact, institutional networks, and editorial trends — powered by the…
...
Health check: run 'thelancet-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("thelancet-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'thelancet-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelAffiliationGrowthCmd(flags))
	rootCmd.AddCommand(newNovelCurateCmd(flags))
	rootCmd.AddCommand(newNovelDriftCmd(flags))
	rootCmd.AddCommand(newNovelMeshCmd(flags))
	rootCmd.AddCommand(newNovelRankAuthorsCmd(flags))
	rootCmd.AddCommand(newNovelVisibilityGapCmd(flags))
	rootCmd.AddCommand(newLancetRefreshCmd(flags))
	rootCmd.AddCommand(newJournalsCmd(flags))
	rootCmd.AddCommand(newCitedByCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newSourcesPromotedCmd(flags))
