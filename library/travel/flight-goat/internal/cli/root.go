...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "flight-goat-pp-cli",
		Short: "Manage flight-goat resources via the flight-goat API",
		Long: `Manage flight-goat resources via the flight-goat API.
...
Run 'flight-goat-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'flight-goat-pp-cli profile list')")
	...
	// Register flight-goat's headline primary and transcendence commands first
	...
	// endpoint remains reachable via 'flight-goat-pp-cli api flights
