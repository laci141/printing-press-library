...
// optCEnabled controls the Option C refutation cue block. Always true in
// production; tests may toggle it to measure the block's isolated impact.
var optCEnabled = true
