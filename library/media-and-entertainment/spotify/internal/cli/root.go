...
Run 'spotify-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.SetVersionTemplate("spotify-pp-cli {{ .Version }}\n")
	...
	rootCmd.AddCommand(newAlbumsCmd(flags))
	rootCmd.AddCommand(newArtistsCmd(flags))
	rootCmd.AddCommand(newAudioFeaturesCmd(flags))
	rootCmd.AddCommand(newAudiobooksCmd(flags))
	rootCmd.AddCommand(newBrowseCmd(flags))
	rootCmd.AddCommand(newChaptersCmd(flags))
	rootCmd.AddCommand(newEpisodesCmd(flags))
	rootCmd.AddCommand(newMeCmd(flags))
	rootCmd.AddCommand(newPlaylistsCmd(flags))
	rootCmd.AddCommand(newRecommendationsCmd(flags))
	rootCmd.AddCommand(newShowsCmd(flags))
	...
	rootCmd.AddCommand(newAudioAnalysisPromotedCmd(flags))
	...
	rootCmd.AddCommand(newTopCmd(flags))      // T4 top drift
	rootCmd.AddCommand(newReleasesCmd(flags)) // T5 releases since
	rootCmd.AddCommand(newPlayCmd(flags))     // T7 play history
